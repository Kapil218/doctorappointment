  ...
  return (
    <div className={styles.calendar_container}>
      ...
      <div className={styles.month_navigation}>
        <button className={styles.nav_btn} onClick={prevMonth}>
          {"<"}
        </button>
        ...
        <button className={styles.nav_btn} onClick={nextMonth}>
          {">"}
        </button>
      </div>
      ...
      <div className={styles.scroll_wrapper}>
        <button className={styles.scroll_btn} onClick={() => scroll("left")}>
          {"<"}
        </button>
        ...
        <button className={styles.scroll_btn} onClick={() => scroll("right")}>
          {">"}
        </button>
      </div>
    </div>
